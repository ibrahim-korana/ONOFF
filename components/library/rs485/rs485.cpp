...
{  
    ...
    xSemaphoreTake(send_paket_sem, 1500 / portTICK_PERIOD_MS); //Paketin gönderilmesini bekle
                ...
                {     
                    ...
                    if (pos == -1) {
                      ...
                      if (pos>0)
                      {
                        ...
                        //printf("paket geldi %d:%d %d=%d %d\n",hd->total_pk,hd->current_pk, receiver,mthis->get_device_id(), hd->sender); 
